...
## Using the program
The program had three main modes that can be accessed through the command line. As the program is set up as a module, these commands should be run from the program's root directory (where this README is located).
<br>
#### Main Usage
...
This is mainly a quality of life feature so when you have chosen which one of the returned images are suitable for keeping, you can delete the others and you don't have to keep track of which folders you have searched through.
